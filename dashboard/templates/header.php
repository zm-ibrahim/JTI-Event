...
<head>
    ...
    <title>Dashboard | JTI Event</title>
...
<body>
    ...
    <div class="d-flex">
        <div style="min-height: 100vh;">
            <div class="collapse collapse-horizontal sticky-top" id="collapseWidthExample" style="height: 100vh;">
                <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px; height:100vh;">
                    <a href="<?= baseURL ?>" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
                        <span class="fs-4">JTI <span class="text-info">Event</span></span>
                    </a>
                    <hr>
                    <ul class="nav nav-pills flex-column mb-auto">
                        ...
                        ?>
                            <li>
                                <a href="<?= baseURL . 'dashboard/scores/list.php' ?>" class="nav-link text-white <?= str_contains($_SERVER['SCRIPT_NAME'], 'dashboard/category') ? 'active' : '' ?>">
                                    <i data-feather="folder" class="me-3"></i>
                                    Scores
                                </a>
                            </li>
